...
#
# python train.py -m "MOT17" --backbone 'resnet50' -L focal --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2 --classification
# python train.py -m "MOT17" --backbone 'resnet50' -L mse --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2
#
...
# python train.py -m "MOT17" --backbone 'resnet50' -L mse --epochs 25 --heads 6 --model 'timeaware' -l 0.001 --dropout 0.2 --node_model
#
# python train.py -m "MOT17" --backbone 'resnet50' -L focal --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2 --classification
python train.py -m "MOT17" --backbone 'resnet50' -L focal --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2 --node_model
...
python train.py -m "MOT20" --backbone 'resnet50' -L focal --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2 --classification
python train.py -m "MOT20" --backbone 'resnet50' -L focal --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2
...
python train.py -m "MOT20" --backbone 'resnet50' -L focal --epochs 25 --heads 6 --model 'transformer' -l 0.001 --dropout 0.2 --classification
python train.py -m "MOT20" --backbone 'resnet50' -L focal --epochs 25  --heads 6 --model 'transformer' -l 0.001 --dropout 0.2 --node_model