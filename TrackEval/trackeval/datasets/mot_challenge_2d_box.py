...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'GT_LOC_FORMAT': '{gt_folder}/{seq}/gt/gt.txt',  # '{gt_folder}/{seq}/gt/MOT17-gt.txt'
    ...
    def __init__(self, config=None):
        ...
        for tracker in self.tracker_list:
            if self.data_is_zipped:
                ...
                for seq in self.seq_list:
                    curr_file = os.path.join(tracker, self.tracker_sub_fol, seq + '.txt')  # self.tracker_fol,
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if self.data_is_zipped:
            ...
            if is_gt:
                ...
                file = os.path.join(tracker, self.tracker_sub_fol, seq + '.txt')  # self.tracker_fol,
